  ...
  Vl = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of Ul(t))
        !ql.call(e, i) &&
          i !== r &&
          wi(e, i, { get: () => t[i], enumerable: !(n = jl(t, i)) || n.enumerable });
    return e;
  };
var Pe = (e, t, r) => (
  (r = e != null ? Bl($l(e)) : {}),
  Vl(t || !e || !e.__esModule ? wi(r, 'default', { value: e, enumerable: !0 }) : r, e)
);
function $(e) {
  return () => e;
}
...
var fs = X((qt) => {
  ...
  f();
  d();
  var Zo = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    Kl = Zo((e) => {
      'use strict';
  ...
  function Ze(e) {
    if (e > on) throw new RangeError('The value "' + e + '" is invalid for option "size"');
  ...
  function zl(e) {
    ...
    if (e.length !== void 0) return typeof e.length != 'number' || _i(e.length) ? Ze(0) : Pi(e);
    if (e.type === 'Buffer' && Array.isArray(e.data)) return Pi(e.data);
  }
  function Ai(e) {
    if (e >= on)
      throw new RangeError(
        'Attempt to allocate Buffer larger than maximum size: 0x' + on.toString(16) + ' bytes',
      );
    return e | 0;
  }
  function Yl(e) {
  ...
  T.prototype.toString = function () {
    let e = this.length;
    return e === 0 ? '' : arguments.length === 0 ? is(this, 0, e) : Zl.apply(this, arguments);
  };
  ...
  function ic(e, t, r) {
    return t === 0 && r === e.length ? Ei.fromByteArray(e) : Ei.fromByteArray(e.slice(t, r));
  }
  function is(e, t, r) {
  ...
  function oc(e) {
    ...
    let r = '',
      n = 0;
    for (; n < t; ) r += String.fromCharCode.apply(String, e.slice(n, (n += zo)));
    return r;
  }
  function sc(e, t, r) {
    let n = '';
  ...
  T.prototype.readFloatLE = function (e, t) {
    return (e = e >>> 0), t || ae(e, 4, this.length), Ut.read(this, e, !0, 23, 4);
  };
  T.prototype.readFloatBE = function (e, t) {
    return (e = e >>> 0), t || ae(e, 4, this.length), Ut.read(this, e, !1, 23, 4);
  };
  T.prototype.readDoubleLE = function (e, t) {
    return (e = e >>> 0), t || ae(e, 8, this.length), Ut.read(this, e, !0, 52, 8);
  };
  T.prototype.readDoubleBE = function (e, t) {
    return (e = e >>> 0), t || ae(e, 8, this.length), Ut.read(this, e, !1, 52, 8);
  };
  ...
  T.prototype.writeBigInt64LE = at(function (e, t = 0) {
    return os(this, e, t, -BigInt('0x8000000000000000'), BigInt('0x7fffffffffffffff'));
  });
  T.prototype.writeBigInt64BE = at(function (e, t = 0) {
    return ss(this, e, t, -BigInt('0x8000000000000000'), BigInt('0x7fffffffffffffff'));
  });
    ...
    function (e, t, r) {
      ...
      return (
        Number.isInteger(r) && Math.abs(r) > 2 ** 32
          ...
          : typeof r == 'bigint' &&
            ((i = String(r)),
            (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = Yo(i)),
            (i += 'n')),
  ...
  function cc(e, t, r) {
    $t(t, 'offset'), (e[t] === void 0 || e[t + r] === void 0) && hr(t, e.length - (r + 1));
  }
  ...
  function fc(e) {
    if (((e = e.split('=')[0]), (e = e.trim().replace(pc, '')), e.length < 2)) return '';
...
var Bi = X((q) => {
  ...
  var ee = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
        ...
        for (var vt = 1, Ye = !0; vt < k.length; vt += 1) {
          ...
          if (
            ...
            if (a && vt + 1 >= k.length) {
              var Bt = a(ne, Ee);
              (Ye = !!Bt),
                Ye && 'get' in Bt && !('originalValue' in Bt.get) ? (ne = Bt.get) : (ne = ne[Ee]);
    ...
    Cc = ee((e) => {
      ...
      function vt(_) {
        return typeof DataView > 'u' ? !1 : st.working ? st(_) : _ instanceof DataView;
      }
      e.isDataView = vt;
  ...
  q.format = function (e) {
    if (!mn(e)) {
      for (var t = [], r = 0; r < arguments.length; r++) t.push(lt(arguments[r]));
      return t.join(' ');
    }
    for (
      var r = 1,
  ...
  function Rc(e, t) {
    var r = lt.styles[t];
    return r ? '\x1B[' + lt.colors[r][0] + 'm' + e + '\x1B[' + lt.colors[r][1] + 'm' : e;
  }
  function Oc(e, t) {
    return e;
  }
...
`) >= 0 && n++,
 ...
 `) +
  ...
  var jc = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  function Uc() {
    var e = new Date(),
  ...
  function qc(e) {
    ...
    return Object.setPrototypeOf(t, Object.getPrototypeOf(e)), Object.defineProperties(t, Ms(e)), t;
  }
  q.callbackify = qc;
});
var Ds = X((Vy, Fs) => {
...
var Vs = X((wh, qs) => {
  ...
  Ne('no-color') || Ne('no-colors') || Ne('color=false') || Ne('color=never')
    ? (ct = 0)
    : (Ne('color') || Ne('colors') || Ne('color=true') || Ne('color=always')) && (ct = 1);
  'FORCE_COLOR' in ue &&
    (ue.FORCE_COLOR === 'true'
      ? (ct = 1)
...
var Qs = X((de, wn) => {
  ...
  function sp() {
    return 'colors' in de.inspectOpts ? !!de.inspectOpts.colors : op.isatty(h.stderr.fd);
  }
  function ap(e) {
...
`,
  ...
  function fp(e) {
    ...
    for (let r = 0; r < t.length; r++) e.inspectOpts[t[r]] = de.inspectOpts[t[r]];
  }
  wn.exports = ji()(de);
...
var Gi = X((Pb, na) => {
  ...
  var zt = {
    resolve: function () {
      ...
      return (e = ra(e, !t)), t ? (e.length > 0 ? '/' + e : '/') : e.length > 0 ? e : '.';
    },
    ...
    relative: function (e, t) {
      if ((Ke(e), Ke(t), e === t || ((e = zt.resolve(e)), (t = zt.resolve(t)), e === t))) return '';
...
var pa = X((s0, Hi) => {
  ...
  var Pp = Object.prototype.hasOwnProperty,
    ve = '~';
  function Pr() {}
  Object.create && ((Pr.prototype = Object.create(null)), new Pr().__proto__ || (ve = !1));
  function vp(e, t, r) {
  ...
  we.prototype.removeListener = function (e, t, r, n) {
    ...
    if (o.fn) o.fn === t && (!n || o.once) && (!r || o.context === r) && Cn(this, i);
    else {
...
var Ps = {};
yr(Ps, { Extensions: () => bs, Public: () => ws, Result: () => xs, Utils: () => Es });
m();
p();
f();
d();
...
function zs(e = 7500) {
  let t = xr.map((r) => r.map((n) => (typeof n == 'string' ? n : JSON.stringify(n))).join(' '))
    .join(`
`);
...
var Ki,
  ...
  ta = !0;
typeof h != 'undefined' &&
  (({ FORCE_COLOR: Ki, NODE_DISABLE_COLORS: Zs, NO_COLOR: Xs, TERM: ea } = h.env || {}),
  (ta = h.stdout && h.stdout.isTTY));
var gp = { enabled: !Zs && Xs == null && ea !== 'dumb' && ((Ki != null && Ki !== '0') || ta) };
function H(e, t) {
  let r = new RegExp(`\\x1b\\[${t}m`, 'g'),
    n = `\x1B[${e}m`,
    i = `\x1B[${t}m`;
  return function (o) {
    return !gp.enabled || o == null ? o : n + (~('' + o).indexOf(i) ? o.replace(r, i + n) : o) + i;
  };
}
var Bh = H(0, 0),
  pt = H(1, 22),
...
f();
d();
var $x = ['JsonNullValueInput', 'NullableJsonNullValueInput', 'JsonNullValueFilter'],
  Rn = Symbol(),
  ro = new WeakMap(),
  Xe = class {
    constructor(t) {
      t === Rn
        ...
        : ro.set(this, `new Prisma.${this._getNamespace()}.${this._getName()}()`);
    }
    _getName() {
...
C.inverseTangent = C.atan = function () {
  ...
  if (l.isFinite()) {
    ...
    if (l.abs().eq(1) && g + 4 <= lo) return (s = je(c, g + 4, y).times(0.25)), (s.s = l.s), s;
  } else {
...
C.logarithm = C.log = function (e) {
  ...
  if (
    ...
    do
      if (
        ((a += 10), (s = yt(l, a)), (n = t ? Ln(c, a + 10) : yt(e, a)), (u = W(s, n, a, 1)), !o)
      ) {
...
C.minus = C.sub = function (e) {
  ...
  for (; l[--s] === 0; ) l.pop();
  for (; l[0] === 0; l.shift()) --r;
  return l[0] ? ((e.d = l), (e.e = jn(l, r)), L ? F(e, a, u) : e) : new v(u === 3 ? -0 : 0);
};
...
C.times = C.mul = function (e) {
  ...
  for (; !o[--s]; ) o.pop();
  return t ? ++r : o.shift(), (e.d = o), (e.e = jn(o, r)), L ? F(e, g.precision, g.rounding) : e;
};
...
C.toDecimalPlaces = C.toDP = function (e, t) {
  ...
  return (
    ...
    e === void 0
      ? r
      : (Se(e, 0, bt), t === void 0 ? (t = n.rounding) : Se(t, 0, 8), F(r, e + r.e + 1, t))
  );
};
...
var W = (function () {
  ...
  return function (n, i, o, s, a, u) {
    ...
    for (
      u ? ((P = 1), (c = n.e - i.e)) : ((u = Ue), (P = D), (c = xe(n.e / P) - xe(i.e / P))),
        re = k.length,
        te = K.length,
        M = new it(Q),
        O = M.d = [],
...
function Na(e, t, r, n) {
  var i,
    ...
    s = Math.ceil(n / D + 4);
  for (L = !1; ; ) {
    if ((r % 2 && ((o = o.times(t)), Sa(o.d, s) && (i = !0)), (r = xe(r / 2)), r === 0)) {
...
function qp(e, t) {
  ...
  for (
    o = t.search(/p/i),
      ...
      s = o >= 0,
      n = e.constructor,
      s && ((t = t.replace('.', '')), (a = t.length), (o = a - o), (i = Na(n, new n(r), o, o * 2))),
      l = Fn(t, r, Ue),
      c = l.length - 1,
      o = c;
    l[o] === 0;
...
function ja(e, t) {
  ...
  if (((r = t.divToInt(i)), r.isZero())) et = n ? 3 : 2;
    ...
    if (((t = t.minus(r.times(i))), t.lte(o))) return (et = _a(r) ? (n ? 2 : 3) : n ? 4 : 1), t;
    et = _a(r) ? (n ? 1 : 4) : n ? 3 : 2;
  }
...
function wf(e) {
  var t,
    ...
    s = new this(1),
    a = [];
  if ((e === void 0 ? (e = this.precision) : Se(e, 1, bt), (n = Math.ceil(e / D)), this.crypto))
...
function Jf(e = {}) {
  let { select: t, ...r } = e;
  return typeof t == 'object' ? ar({ ...r, _count: t }) : ar({ ...r, _count: { _all: !0 } });
}
function Gf(e = {}) {
  return typeof e.select == 'object' ? (t) => Jn(e)(t)._count : (t) => Jn(e)(t)._count._all;
}
function Ha(e, t) {
...
var Xa = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  eu = (e, t, r) =>
    Xa(t).reduceRight((n, i, o, s) => Object.assign({}, ho(e, s.slice(0, o)), { [i]: n }), r);
function zf(e, t) {
...
var Xf = (e) => e,
  ...
  B = {
    ...
    disableWorkerMessageHandler: Gn.Prism && Gn.Prism.disableWorkerMessageHandler,
    util: {
      encode: function (e) {
        if (e instanceof $e) {
          let t = e;
...
function od({ callsite: e, message: t, originalMethod: r, isPanic: n, callArguments: i }, o) {
  var g;
  let s = {
...
function cd(e, t, r) {
  return async (n) => {
    ...
    return await r(n).catch((o) => {
      throw o instanceof me && o.code === 'P2025' ? new dt(`No ${e} found`, t) : o;
    });
  };
}
m();
...
f();
d();
function zn({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
  var s;
  if (Array.isArray(t)) {
    for (let a = 0; a < t.length; a++)
      t[a] = zn({ result: t[a], args: r, modelName: i, runtimeDataModel: n, visitor: e });
    return t;
  }
...
function cu({
  ...
  for (let [o, s] of Object.entries(e)) {
    ...
    t[o] = zn({ visitor: i, result: t[o], args: l, modelName: u.type, runtimeDataModel: n });
  }
}
function pu({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i }) {
  return n.isEmpty() || e == null || typeof e != 'object' || !i.models[t]
    ...
    : zn({
        ...
        modelName: t,
        runtimeDataModel: i,
        visitor: (s, a, u) => lu({ result: s, modelName: He(a), select: u.select, extensions: n }),
      });
}
m();
p();
      ...
      n === r.length
        ...
        : r[n]({
            ...
            query: (u, l = t) => {
              ...
              return (l.customDataProxyFetch = bu(o, c)), (l.args = u), mu(e, l, r, n + 1);
            },
          })
    );
  });
...
function xu(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ? e
    : xd({ ...e, ...wu(t.name, e, t.result.$allModels), ...wu(t.name, e, t.result[n]) });
}
function xd(e) {
  let t = new Qe(),
    r = (n, i) =>
...
\`\`\``
      : '',
    c = (0, Eo.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
function Ou() {
  ...
  return typeof Netlify == 'object'
    ...
    ? 'lagon'
    : ((r = (t = globalThis.process) == null ? void 0 : t.release) == null ? void 0 : r.name) === Td
    ? 'node'
    : globalThis.Bun
    ? 'bun'
    : globalThis.fastly
...
function ei({ inlineDatasources: e, overrideDatasources: t, env: r, clientVersion: n }) {
  var u, l;
  let i,
    o = Object.keys(e)[0],
...
To solve this, provide the connection string directly: https://pris.ly/d/cloudflare-datasource-url`,
  ...
  if (i === void 0) throw new Y('error: Missing URL environment variable, value, or override.', n);
  return i;
}
m();
p();
...
async function Hr(e, t) {
  ...
  if (n.type === 'DataProxyError') {
    if (n.body === 'InternalDataProxyError') throw new pr(r, 'Internal Data Proxy error');
...
async function Nt(e, t, r = (n) => n) {
  ...
  try {
    return typeof fetch == 'function' ? await r(fetch)(e, t) : await r(So)(e, t);
  } catch (o) {
...
var Lu = 3,
  ...
  Yr = class extends lr {
    ...
    async handleError(r) {
      if (r instanceof Dt)
        throw (await this.uploadSchema(), new cr({ clientVersion: this.clientVersion, cause: r }));
      if (r) throw r;
    }
  };
m();
...
var Nd = typeof TextDecoder == 'undefined' ? (0, module.require)('util').TextDecoder : TextDecoder,
  ju = new Nd('utf-8', { ignoreBOM: !0, fatal: !0 });
ju.decode();
var ri = null;
function ii() {
  return (ri === null || ri.byteLength === 0) && (ri = new Uint8Array(I.memory.buffer)), ri;
}
function dr(e, t) {
...
var oe = 0,
  Bd = typeof TextEncoder == 'undefined' ? (0, module.require)('util').TextEncoder : TextEncoder,
  oi = new Bd('utf-8'),
  jd =
...
var ni = null;
function Fe() {
  return (ni === null || ni.byteLength === 0) && (ni = new Int32Array(I.memory.buffer)), ni;
}
function Ud(e, t, r, n) {
...
var Uu = {
  async loadLibrary(e) {
    ...
    if (i == null)
      throw new Y('The loaded wasm module was unexpectedly `undefined` or `null` once loaded', r);
      ...
      try {
        ...
        if (l.errors)
          throw l.errors.length === 1
            ...
            : new ge(JSON.stringify(l.errors), { clientVersion: this.config.clientVersion });
        if (this.loggerRustPanic) throw this.loggerRustPanic;
        return { data: l, elapsed: 0 };
      } catch (l) {
        if (l instanceof Y) throw l;
        if (l.code === 'GenericFailure' && (u = l.message) != null && u.startsWith('PANIC:'))
          throw new Le(this.getErrorMessageWithLink(l.message), this.config.clientVersion);
...
${c.backtrace}`,
    ...
    async requestBatch(r, { transaction: n, traceparent: i }) {
      ...
      if (a.errors)
        throw a.errors.length === 1
          ...
          : new ge(JSON.stringify(a.errors), { clientVersion: this.config.clientVersion });
    ...
    getExternalAdapterError(r) {
      ...
      if (r.error_code === xm && this.config.adapter) {
        ...
        _n(typeof i == 'number', 'Malformed external JS error received from the engine');
...
function Tm(e) {
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...n,
          argument: { ...n.argument, typeNames: Am(o.argument.typeNames, n.argument.typeNames) },
        })
      : t.set(i, n);
  }
...
function Sm(e, t) {
  ...
  if (o && ((a = o.getField(n)) == null || a.markAsError(), i))
    for (let u of i.fields) u.isRelation && o.addSuggestion(new nt(u.name, 'true'));
  t.addErrorMessage((u) => {
...
function Mm(e, t) {
  ...
  n && (n.removeAllFields(), Yu(n, r)),
    t.addErrorMessage((a) =>
      i
        ? `The ${a.red('`select`')} statement for type ${a.bold(r.name)} must not be empty. ${tn(
            a,
          )}`
...
function Rm(e, t) {
  ...
  i && ((o = i.value.getField(n)) == null || o.markAsError(), Yu(i.value, e.outputType)),
    t.addErrorMessage((s) => {
...
function Om(e, t) {
  ...
  n instanceof le && ((i = n.getField(r)) == null || i.markAsError(), jm(n, e.arguments)),
    t.addErrorMessage((o) =>
      Hu(
        o,
        r,
...
function Hu(e, t, r) {
  let n = [`Unknown argument \`${e.red(t)}\`.`],
    i = $m(t, r);
  return i && n.push(`Did you mean \`${e.green(i)}\`?`), r.length > 0 && n.push(tn(e)), n.join(' ');
}
function km(e, t) {
  let r;
  t.addErrorMessage((u) =>
...
function Fm(e, t) {
  ...
  let r = e.argument.name,
    n = t.arguments.getDeepSubSelectionValue(e.selectionPath);
  n instanceof le && ((i = n.getDeepFieldValue(e.argumentPath)) == null || i.markAsError()),
    t.addErrorMessage((o) => {
      let s = fi(
        'or',
...
function Yu(e, t) {
  for (let r of t.fields) e.hasField(r.name) || e.addSuggestion(new nt(r.name, 'true'));
}
function jm(e, t) {
  for (let r of t) e.hasField(r.name) || e.addSuggestion(new nt(r.name, r.typeNames.join(' | ')));
}
function Zu(e, t) {
  if (t.kind === 'object')
    for (let r of t.fields)
      e.hasField(r.name) || e.addSuggestion(new nt(r.name, r.typeNames.join(' | ')));
}
function pi(e) {
  let t = [...e],
    r = t.pop();
...
function Km(e, t) {
  let r = {};
  return (
    e.model && !e.isRawAction() && ((r.$composites = !0), (r.$scalars = !0)), t && Qm(r, t, e), r
  );
}
function Qm(e, t, r) {
  for (let [n, i] of Object.entries(t)) {
    ...
    o &&
      ...
      i === !0 ? (e[n] = !0) : typeof i == 'object' && (e[n] = No(i, r.nestSelection(n)));
  }
}
function Jm(e, t) {
  let r = {},
  ...
  for (let [o, s] of Object.entries(i)) {
    let a = t.findField(o);
    (n != null && n[o] && !a) ||
      (s === !0 ? (r[o] = !0) : typeof s == 'object' && (r[o] = No(s, t.nestSelection(o))));
  }
  return r;
}
function el(e, t) {
  ...
  if (ir(e)) return { $type: 'FieldRef', value: { _ref: e.name, _container: e.modelName } };
  ...
  if (e instanceof Xe) {
    if (e !== no.instances[e._getName()]) throw new Error('Invalid ObjectEnumValue');
...
var Zm = /^(\s*alter\s)/i,
  al = be('prisma:client');
function Lo(e, t, r, n) {
  if (!(e !== 'postgresql' && e !== 'cockroachdb') && r.length > 0 && Zm.exec(t))
    ...
    (n) => {
      ...
      if (Array.isArray(n)) {
        ...
        switch (t) {
          case 'sqlite':
          case 'mysql': {
            (i = n.sql), (o = { values: rn(n.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'cockroachdb':
          case 'postgresql':
          case 'postgres': {
            (i = n.text), (o = { values: rn(n.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'sqlserver': {
            (i = nl(n)), (o = { values: rn(n.values), __prismaRawParameters__: !0 });
            break;
          }
          default:
      ...
      return (
        o != null && o.values ? al(`prisma.${e}(${i}, ${o.values})`) : al(`prisma.${e}(${i})`),
...
function og(e, t) {
  return gi(e) && (t == null ? void 0 : t.kind) === 'batch' && e.batchRequestIdx !== t.index;
}
function sg(e) {
...
var cg = { requestArgsToMiddlewareArgs: (e) => e, middlewareArgsToRequestArgs: (e) => e },
  ...
  class t {
        ...
        if (
          ...
          for (let S of v.log) {
            ...
            R &&
              this.$on(R, (j) => {
                var U;
                Yt.log(`${(U = Yt.tags[R]) != null ? U : ''}`, j.message || j.query);
              });
          }
    ...
    $executeRawInternal(n, i, o, s) {
      ...
      return this._request({
        ...
        transaction: n,
        clientMethod: i,
        argsMapper: Bo({ clientMethod: i, activeProvider: a, activeProviderFlavour: u }),
