  ...
  Zl = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let o of Hl(t))
        !Yl.call(e, o) &&
          o !== r &&
          Ao(e, o, { get: () => t[o], enumerable: !(n = Wl(t, o)) || n.enumerable });
    return e;
  };
var _e = (e, t, r) => (
  (r = e != null ? Gl(zl(e)) : {}),
  Zl(t || !e || !e.__esModule ? Ao(r, 'default', { value: e, enumerable: !0 }) : r, e)
);
function J(e) {
  return () => e;
}
...
var Es = ne((Wt) => {
  ...
  var as = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    Xl = as((e) => {
      ...
      function c(_) {
        ...
        return (
          F === 2 &&
            ((T = (r[_.charCodeAt(Q)] << 2) | (r[_.charCodeAt(Q + 1)] >> 4)), (O[k++] = T & 255)),
          F === 1 &&
            ((T =
              (r[_.charCodeAt(Q)] << 10) |
      ...
      function h(_, T, S) {
        for (var I, F = [], O = T; O < S; O += 3)
          (I = ((_[O] << 16) & 16711680) + ((_[O + 1] << 8) & 65280) + (_[O + 2] & 255)),
            F.push(y(I));
        return F.join('');
      }
      function A(_) {
        for (var T, S = _.length, I = S % 3, F = [], O = 16383, k = 0, K = S - I; k < K; k += O)
    ...
    ec = as((e) => {
      (e.read = function (t, r, n, o, i) {
        ...
        (e.write = function (t, r, n, o, i, s) {
          ...
          for (a = (a << i) | u, c += i; c > 0; t[n + _] = a & 255, _ += T, a /= 256, c -= 8);
          t[n + _ - T] |= S * 128;
        });
    }),
    Co = Xl(),
  ...
  function rt(e) {
    if (e > cn) throw new RangeError('The value "' + e + '" is invalid for option "size"');
  ...
  function ic(e) {
    ...
    if (e.length !== void 0) return typeof e.length != 'number' || ko(e.length) ? rt(0) : So(e);
    if (e.type === 'Buffer' && Array.isArray(e.data)) return So(e.data);
  }
  function Oo(e) {
    if (e >= cn)
      throw new RangeError(
        'Attempt to allocate Buffer larger than maximum size: 0x' + cn.toString(16) + ' bytes',
      );
    return e | 0;
  }
  function sc(e) {
  ...
  C.prototype.toString = function () {
    let e = this.length;
    return e === 0 ? '' : arguments.length === 0 ? ds(this, 0, e) : ac.apply(this, arguments);
  };
    ...
    for (; o < r; ) {
      ...
      if (o + a <= r) {
        ...
        switch (a) {
          ...
          case 2:
            (u = e[o + 1]),
              (u & 192) === 128 && ((y = ((i & 31) << 6) | (u & 63)), y > 127 && (s = y));
            break;
          case 3:
            (u = e[o + 1]),
              (l = e[o + 2]),
  ...
  C.prototype.readInt8 = function (e, t) {
    return (
      (e = e >>> 0), t || le(e, 1, this.length), this[e] & 128 ? (255 - this[e] + 1) * -1 : this[e]
    );
  };
  ...
  C.prototype.readFloatLE = function (e, t) {
    return (e = e >>> 0), t || le(e, 4, this.length), Jt.read(this, e, !0, 23, 4);
  };
  C.prototype.readFloatBE = function (e, t) {
    return (e = e >>> 0), t || le(e, 4, this.length), Jt.read(this, e, !1, 23, 4);
  };
  C.prototype.readDoubleLE = function (e, t) {
    return (e = e >>> 0), t || le(e, 8, this.length), Jt.read(this, e, !0, 52, 8);
  };
  C.prototype.readDoubleBE = function (e, t) {
    return (e = e >>> 0), t || le(e, 8, this.length), Jt.read(this, e, !1, 52, 8);
  };
  ...
  function wc(e, t, r) {
    Gt(t, 'offset'), (e[t] === void 0 || e[t + r] === void 0) && Er(t, e.length - (r + 1));
  }
  ...
  function Ec(e) {
    if (((e = e.split('=')[0]), (e = e.trim().replace(xc, '')), e.length < 2)) return '';
...
var Ko = ne((G) => {
  ...
  var oe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    ...
    Sc = oe((e, t) => {
      ...
      var r = 'Function.prototype.bind called on incompatible ',
        ...
        a = function (l, c) {
          for (var y = [], h = c || 0, A = 0; h < l.length; h += 1, A += 1) y[A] = l[h];
          return y;
        },
        u = function (l, c) {
      ...
      t.exports = function (l) {
        ...
        if (
          ((h = w(
            'binder',
            'return function (' + u(T, ',') + '){ return binder.apply(this,arguments); }',
          )(A)),
          c.prototype)
        ) {
          var I = function () {};
          (I.prototype = c.prototype), (h.prototype = new I()), (I.prototype = null);
        }
        return h;
      };
    }),
        ...
        ut = function (H, W) {
          ...
          if ((k(F, N) && ((me = F[N]), (N = '%' + me[0] + '%')), k(T, N))) {
            ...
            if ((ge === A && (ge = I(N)), typeof ge > 'u' && !W))
              throw new i(
                'intrinsic ' + H + ' exists, but is not available. Please file an issue!',
              );
        ...
        for (var Ct = 1, tt = !0; Ct < N.length; Ct += 1) {
          ...
          if (
            ...
            if (!(Ae in ae)) {
              if (!W)
                throw new i(
                  'base intrinsic for ' + H + ' exists, but the property is not available.',
                );
              return;
            }
            if (a && Ct + 1 >= N.length) {
              var Vt = a(ae, Ae);
              (tt = !!Vt),
                tt && 'get' in Vt && !('originalValue' in Vt.get) ? (ae = Vt.get) : (ae = ae[Ae]);
    ...
    Rc = oe((e, t) => {
      ...
      t.exports = function (y) {
        ...
        if (a && u) {
          var A = a(h, 'length');
          A.configurable && u(h, 'length', { value: 1 + l(0, y.length - (arguments.length - 1)) });
        }
        return h;
      };
      var c = function () {
    ...
    Fc = oe((e, t) => {
      ...
      var A = function (T) {
        ...
        _ = Ls();
      t.exports = function (T) {
        return _(T) ? (!a || !(Symbol.toStringTag in T) ? c(s(T), 8, -1) : A(T)) : !1;
      };
    }),
    Dc = oe((e) => {
      'use strict';
      ...
      function me(R) {
        return typeof WeakMap > 'u' ? !1 : N.working ? N(R) : R instanceof WeakMap;
      }
      e.isWeakMap = me;
      function ge(R) {
      ...
      function _t(R) {
        return typeof ArrayBuffer > 'u' ? !1 : ae.working ? ae(R) : R instanceof ArrayBuffer;
      }
      e.isArrayBuffer = _t;
      function ct(R) {
      ...
      function Ct(R) {
        return typeof DataView > 'u' ? !1 : ct.working ? ct(R) : R instanceof DataView;
      }
      e.isDataView = Ct;
  ...
  G.format = function (e) {
    if (!wn(e)) {
      for (var t = [], r = 0; r < arguments.length; r++) t.push(dt(arguments[r]));
      return t.join(' ');
    }
    for (
      var r = 1,
  ...
  function jc(e, t) {
    var r = dt.styles[t];
    return r ? '\x1B[' + dt.colors[r][0] + 'm' + e + '\x1B[' + dt.colors[r][1] + 'm' : e;
  }
  function Uc(e, t) {
    return e;
  }
...
`) >= 0 && n++,
 ...
 `) +
  ...
  var Wc = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  function Hc() {
    var e = new Date(),
  ...
  G.promisify = function (e) {
    ...
    if (Rt && e[Rt]) {
      ...
      return (
        Object.defineProperty(t, Rt, { value: t, enumerable: !1, writable: !1, configurable: !0 }),
        t
      );
    }
    function t() {
    ...
    function r(c) {
      ...
      return (
        ...
        Object.defineProperty(T, 'enabled', {
          ...
          configurable: !1,
          get: () =>
            h !== null ? h : (A !== r.namespaces && ((A = r.namespaces), (_ = r.enabled(c))), _),
          set: (S) => {
            h = S;
          },
        }),
...
var Zs = ne((Xb, Ys) => {
  ...
  Ue('no-color') || Ue('no-colors') || Ue('color=false') || Ue('color=never')
    ? (mt = 0)
    : (Ue('color') || Ue('colors') || Ue('color=true') || Ue('color=always')) && (mt = 1);
  'FORCE_COLOR' in ce &&
    (ce.FORCE_COLOR === 'true'
      ? (mt = 1)
      : ce.FORCE_COLOR === 'false'
        ? (mt = 0)
        : (mt = ce.FORCE_COLOR.length === 0 ? 1 : Math.min(parseInt(ce.FORCE_COLOR, 10), 3)));
  function Go(e) {
  ...
  function Wo(e, t) {
    ...
    return /-256(color)?$/i.test(ce.TERM)
      ? 2
      : /^screen|^xterm|^vt100|^vt220|^rxvt|color|ansi|cygwin|linux/i.test(ce.TERM) ||
          'COLORTERM' in ce
        ? 1
        : r;
  }
...
var ea = ne((ye, Tn) => {
  ...
  function gp() {
    return 'colors' in ye.inspectOpts ? !!ye.inspectOpts.colors : mp.isatty(b.stderr.fd);
  }
  function yp(e) {
...
`,
  ...
  Xs.O = function (e) {
    return (this.inspectOpts.colors = this.useColors), vn.inspect(e, this.inspectOpts);
  };
});
var ta = ne((c0, Ho) => {
  'use strict';
...
var Xo = ne((bw, fa) => {
  ...
  var rr = {
    ...
    relative: function (e, t) {
      if ((We(e), We(t), e === t || ((e = rr.resolve(e)), (t = rr.resolve(t)), e === t))) return '';
      ...
      var A = '';
      for (c = r + l + 1; c <= n; ++c)
        (c === n || e.charCodeAt(c) === 47) && (A.length === 0 ? (A += '..') : (A += '/..'));
      return A.length > 0
        ? A + t.slice(i + l)
...
var xa = ne((lx, ti) => {
  ...
  var Op = Object.prototype.hasOwnProperty,
    Ce = '~';
  function _r() {}
  Object.create && ((_r.prototype = Object.create(null)), new _r().__proto__ || (Ce = !1));
  function Ip(e, t, r) {
  ...
  Pe.prototype.removeListener = function (e, t, r, n) {
    ...
    if (i.fn) i.fn === t && (!n || i.once) && (!r || i.context === r) && On(this, o);
    else {
...
var Os = {};
xr(Os, { Extensions: () => Cs, Public: () => Ss, Result: () => Ms, Utils: () => Rs });
g();
p();
f();
d();
...
function ia(e = 7500) {
  let t = Tr.map((r) => r.map((n) => (typeof n == 'string' ? n : JSON.stringify(n))).join(' '))
    .join(`
`);
...
var zo,
  ...
  ca = !0;
typeof b != 'undefined' &&
  (({ FORCE_COLOR: zo, NODE_DISABLE_COLORS: aa, NO_COLOR: ua, TERM: la } = b.env || {}),
  (ca = b.stdout && b.stdout.isTTY));
var Tp = { enabled: !aa && ua == null && la !== 'dumb' && ((zo != null && zo !== '0') || ca) };
function X(e, t) {
  let r = new RegExp(`\\x1b\\[${t}m`, 'g'),
    n = `\x1B[${e}m`,
    o = `\x1B[${t}m`;
  return function (i) {
    return !Tp.enabled || i == null ? i : n + (~('' + i).indexOf(o) ? i.replace(r, o + n) : i) + o;
  };
}
var P0 = X(0, 0),
  gt = X(1, 22),
...
d();
m();
var vP = ['JsonNullValueInput', 'NullableJsonNullValueInput', 'JsonNullValueFilter'],
  Dn = Symbol(),
  ui = new WeakMap(),
  nt = class {
    constructor(t) {
      t === Dn
        ...
        : ui.set(this, `new Prisma.${this._getNamespace()}.${this._getName()}()`);
    }
    _getName() {
...
var pi = class {
    ...
    return e.getConnectionInfo && (n.getConnectionInfo = qp(t, e.getConnectionInfo.bind(e))), n;
  },
  $p = (e, t) => ({
    provider: t.provider,
    options: t.options,
...
M.inverseTangent = M.atan = function () {
  ...
  if (l.isFinite()) {
    ...
    if (l.abs().eq(1) && y + 4 <= gi) return (s = Ve(c, y + 4, h).times(0.25)), (s.s = l.s), s;
  } else {
...
M.logarithm = M.log = function (e) {
  ...
  if (
    ...
    do
      if (
        ((a += 10), (s = wt(l, a)), (n = t ? qn(c, a + 10) : wt(e, a)), (u = Z(s, n, a, 1)), !i)
      ) {
...
M.minus = M.sub = function (e) {
  ...
  if (((l = A.d), (h = e.d), (a = _.precision), (u = _.rounding), !l[0] || !h[0])) {
    if (h[0]) e.s = -e.s;
  ...
  for (; l[--s] === 0; ) l.pop();
  for (; l[0] === 0; l.shift()) --r;
  return l[0] ? ((e.d = l), (e.e = Kn(l, r)), q ? B(e, a, u) : e) : new _(u === 3 ? -0 : 0);
};
...
M.times = M.mul = function (e) {
  ...
  if (((e.s *= c.s), !h || !h[0] || !A || !A[0]))
    return new y(
      !e.s || (h && !h[0] && !A) || (A && !A[0] && !h) ? NaN : !h || !A ? e.s / 0 : e.s * 0,
    );
  for (
    r = ve(c.e / U) + ve(e.e / U),
      u = h.length,
  ...
  for (n = l; --n >= 0; ) {
    for (t = 0, o = u + n; o > n; )
      (a = i[o] + A[n] * h[o - n - 1] + t), (i[o--] = a % Ke | 0), (t = (a / Ke) | 0);
    i[o] = (i[o] + t) % Ke | 0;
  }
  for (; !i[--s]; ) i.pop();
  return t ? ++r : i.shift(), (e.d = i), (e.e = Kn(i, r)), q ? B(e, y.precision, y.rounding) : e;
};
...
M.toDecimalPlaces = M.toDP = function (e, t) {
  ...
  return (
    ...
    e === void 0
      ? r
      : (Ie(e, 0, Et), t === void 0 ? (t = n.rounding) : Ie(t, 0, 8), B(r, e + r.e + 1, t))
  );
};
...
M.toFraction = function (e) {
  ...
  for (
    q = !1, a = new T(we(_)), c = T.precision, T.precision = i = _.length * U * 2;
...
M.toNearest = function (e, t) {
  ...
  return (
    e.d[0] ? ((q = !1), (r = Z(r, e, 0, t, 1).times(e)), (q = !0), B(r)) : ((e.s = r.s), (r = e)), r
  );
};
M.toNumber = function () {
  return +this;
...
var Z = (function () {
  ...
  return function (n, o, i, s, a, u) {
    ...
    if (!W || !W[0] || !N || !N[0])
      return new ut(
        !n.s || !o.s || (W ? N && W[0] == N[0] : !N) ? NaN : (W && W[0] == 0) || !N ? H * 0 : H / 0,
      );
    for (
      u ? ((A = 1), (c = n.e - o.e)) : ((u = Ke), (A = U), (c = ve(n.e / A) - ve(o.e / A))),
        se = N.length,
        ie = W.length,
        I = new ut(H),
        F = I.d = [],
...
function B(e, t, r, n) {
  ...
  e: if (t != null) {
    ...
    if (((i = t - o), i < 0))
      (i += U), (s = t), (c = y[(h = 0)]), (u = (c / ue(10, o - s - 1)) % 10 | 0);
    ...
    if (
      ...
      return (
        (y.length = 0),
        l
          ? ((t -= e.e + 1), (y[0] = ue(10, (U - (t % U)) % U)), (e.e = -t || 0))
          : (y[0] = e.e = 0),
        e
      );
    if (
  ...
  return (
    q && (e.e > A.maxE ? ((e.d = null), (e.e = NaN)) : e.e < A.minE && ((e.e = 0), (e.d = [0]))), e
  );
}
function Ye(e, t, r) {
...
function Ja(e, t, r, n) {
  var o,
    ...
    s = Math.ceil(n / U + 4);
  for (q = !1; ; ) {
    if ((r % 2 && ((i = i.times(t)), Ba(i.d, s) && (o = !0)), (r = ve(r / 2)), r === 0)) {
...
function yi(e, t) {
  ...
  for (t == null ? ((q = !1), (u = _)) : (u = t), a = new h(0.03125); e.e > -2; )
    (e = e.times(a)), (y += 5);
  for (
...
function wt(e, t) {
  ...
  if (
    ...
    (i = T.e), n > 1 ? ((T = new I('0.' + r)), i++) : (T = new I(n + '.' + r.slice(1)));
  } else
    return (
...
function hi(e, t) {
  ...
  if (((t = t.slice(n, o)), t)) {
    if (
      ((o -= n), (e.e = r = r - n - 1), (e.d = []), (n = (r + 1) % U), r < 0 && (n += U), n < o)
    ) {
...
function Ha(e, t) {
  ...
  if (((r = t.divToInt(o)), r.isZero())) ot = n ? 3 : 2;
    ...
    if (((t = t.minus(r.times(o))), t.lte(i))) return (ot = La(r) ? (n ? 2 : 3) : n ? 4 : 1), t;
    ot = La(r) ? (n ? 1 : 4) : n ? 3 : 2;
  }
...
function bi(e, t, r, n) {
  ...
  if (
    ...
    for (
      c = Ye(e),
        s = c.indexOf('.'),
        _ ? ((o = 2), t == 16 ? (r = r * 4 - 3) : t == 8 && (r = r * 3 - 2)) : (o = t),
        s >= 0 &&
          ((c = c.replace('.', '')),
          (h = new A(1)),
          (h.e = c.length - s),
      ...
      if (
        ...
        (l =
          n < 4
            ...
            : s > a ||
              (s === a && (n === 4 || l || (n === 6 && y[r - 1] & 1) || n === (e.s < 0 ? 8 : 7)))),
        (y.length = r),
        l)
      )
...
function Mf(e) {
  var t,
    ...
    s = new this(1),
    a = [];
  if ((e === void 0 ? (e = this.precision) : Ie(e, 1, Et), (n = Math.ceil(e / U)), this.crypto))
  ...
  for (
    n = a[--i], e %= U, n && e && ((o = ue(10, U - e)), (a[i] = ((n / o) | 0) * o));
    a[i] === 0;
    i--
  )
    a.pop();
...
function rd(e = {}) {
  let { select: t, ...r } = e;
  return typeof t == 'object' ? dr({ ...r, _count: t }) : dr({ ...r, _count: { _all: !0 } });
}
function nd(e = {}) {
...
var lu = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  cu = (e, t, r) =>
    lu(t).reduceRight((n, o, i, s) => Object.assign({}, Pi(e, s.slice(0, i)), { [o]: n }), r);
function sd(e, t) {
...
var ld = (e) => e,
  ...
  V = {
    ...
    util: {
      ...
      objId: function (e) {
        return e.__id || Object.defineProperty(e, '__id', { value: ++cd }), e.__id;
      },
...
function gd({ callsite: e, message: t, originalMethod: r, isPanic: n, callArguments: o }, i) {
  var y;
  let s = {
  ...
  if (l && c) {
    ...
    (s.functionName = `${A.code})`),
      (s.location = a),
      n || (l = l.mapLineAt(a.lineNumber, (T) => T.slice(0, A.openingBraceIndex))),
...
function yu(e, t, r, n) {
  return e === qe.ModelAction.findFirstOrThrow || e === qe.ModelAction.findUniqueOrThrow
    ? xd(t, r, n)
    : n;
}
function xd(e, t, r) {
  return async (n) => {
    ...
    return await r(n).catch((i) => {
      throw i instanceof he && i.code === 'P2025' ? new ht(`No ${e} found`, t) : i;
    });
  };
}
g();
...
function Eu({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: o }) {
  return n.isEmpty() || e == null || typeof e != 'object' || !o.models[t]
    ...
    : to({
        ...
        modelName: t,
        runtimeDataModel: o,
        visitor: (s, a, u) => wu({ result: s, modelName: Xe(a), select: u.select, extensions: n }),
      });
}
g();
p();
      ...
      n === r.length
        ...
        : r[n]({
            ...
            query: (u, l = t) => {
              ...
              return (l.customDataProxyFetch = Su(i, c)), (l.args = u), Tu(e, l, r, n + 1);
            },
          })
    );
  });
...
function Ru(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ? e
    : Rd({ ...e, ...Mu(t.name, e, t.result.$allModels), ...Mu(t.name, e, t.result[n]) });
}
function Rd(e) {
  let t = new He(),
    r = (n, o) =>
...
function io({ inlineDatasources: e, overrideDatasources: t, env: r, clientVersion: n }) {
  var u, l;
  let o,
    i = Object.keys(e)[0],
...
async function Xr(e, t) {
  ...
  if (n.type === 'DataProxyError') {
    if (n.body === 'InternalDataProxyError') throw new hr(r, 'Internal Data Proxy error');
    if ('EngineNotStarted' in n.body) {
      if (n.body.EngineNotStarted.reason === 'SchemaMissing') return new Ut(r);
      if (n.body.EngineNotStarted.reason === 'EngineVersionNotSupported') throw new Jr(r);
    ...
    if ('InvalidRequestError' in n.body) throw new Hr(r, n.body.InvalidRequestError.reason);
  }
...
async function Qd(e, t) {
  ...
  if (i !== void 0 || n === '0.0.0' || n === 'in-memory') {
    ...
    try {
      ...
      throw (console.error('JSON.parse error: body fetched from unpkg.com: ', T), I);
    }
    return S.version;
  }
  throw new jt('Only `major.minor.patch` versions are supported by Accelerate.', {
    clientVersion: n,
  });
}
...
var Gu = 3,
  ...
  tn = class extends gr {
    ...
    async handleError(t) {
      if (t instanceof Ut)
        throw (await this.uploadSchema(), new yr({ clientVersion: this.clientVersion, cause: t }));
      if (t) throw t;
    }
  };
g();
...
xr(Ui, {
  ...
  __wbindgen_closure_wrapper5582: () => Ig,
...
var Wd = typeof TextDecoder == 'undefined' ? (0, module.require)('util').TextDecoder : TextDecoder,
  Hu = new Wd('utf-8', { ignoreBOM: !0, fatal: !0 });
Hu.decode();
var ao = null;
function po() {
  return (ao === null || ao.byteLength === 0) && (ao = new Uint8Array(L.memory.buffer)), ao;
}
function on(e, t) {
...
var de = 0,
  Hd = typeof TextEncoder == 'undefined' ? (0, module.require)('util').TextEncoder : TextEncoder,
  fo = new Hd('utf-8'),
  zd =
...
var uo = null;
function Be() {
  return (uo === null || uo.byteLength === 0) && (uo = new Int32Array(L.memory.buffer)), uo;
}
var lo = null;
function Yd() {
  return (lo === null || lo.byteLength === 0) && (lo = new Float64Array(L.memory.buffer)), lo;
}
var co = null;
function Zd() {
  return (co === null || co.byteLength === 0) && (co = new BigInt64Array(L.memory.buffer)), co;
}
function Bi(e) {
  let t = typeof e;
...
function nm(e, t, r, n) {
  L.wasm_bindgen__convert__closures__invoke2_mut__h3b98f66135a9eb56(e, t, j(r), j(n));
}
var nn = class {
  __destroy_into_raw() {
  ...
  zu = {
    async loadLibrary(e) {
      ...
      if ($i === void 0) {
        ...
        ($i = new WebAssembly.Instance(i, { './query_engine_bg.js': Ui }).exports), ji($i);
      }
      return {
        debugPanic() {
  ...
  sn = class extends gr {
    ...
    async transaction(t, r, n) {
      ...
      if (t === 'start') {
        ...
        t === 'commit'
          ...
          : t === 'rollback' &&
            (i = await ((y = this.engine) == null ? void 0 : y.rollbackTransaction(n.id, o)));
    ...
    async start() {
      if (
        ...
        return (
          et(`library already starting, this.libraryStarted: ${this.libraryStarted}`),
          this.libraryStartingPromise
        );
...
${l.backtrace}`,
    ...
    async requestBatch(t, { transaction: r, traceparent: n }) {
      ...
      if (s.errors)
        throw s.errors.length === 1
          ...
          : new be(JSON.stringify(s.errors), { clientVersion: this.config.clientVersion });
    ...
    getExternalAdapterError(t) {
      ...
      if (t.error_code === kg && this.config.adapter) {
        ...
        In(typeof n == 'number', 'Malformed external JS error received from the engine');
...
function $g(e, t) {
  ...
  if (i && ((a = i.getField(n)) == null || a.markAsError(), o))
    for (let u of o.fields) u.isRelation && i.addSuggestion(new at(u.name, 'true'));
  t.addErrorMessage((u) => {
...
function qg(e, t) {
  ...
  n && (n.removeAllFields(), al(n, r)),
    t.addErrorMessage((a) =>
      o
        ? `The ${a.red('`select`')} statement for type ${a.bold(r.name)} must not be empty. ${an(
            a,
          )}`
...
function Vg(e, t) {
  ...
  o && ((i = o.value.getField(n)) == null || i.markAsError(), al(o.value, e.outputType)),
    t.addErrorMessage((s) => {
...
function Kg(e, t) {
  ...
  n instanceof pe && ((o = n.getField(r)) == null || o.markAsError(), Zg(n, e.arguments)),
    t.addErrorMessage((i) =>
      il(
        i,
        r,
...
function il(e, t, r) {
  let n = [`Unknown argument \`${e.red(t)}\`.`],
    o = ey(t, r);
  return o && n.push(`Did you mean \`${e.green(o)}\`?`), r.length > 0 && n.push(an(e)), n.join(' ');
}
function Jg(e, t) {
  let r;
  t.addErrorMessage((u) =>
...
function Gg(e, t) {
  ...
  let r = e.argument.name,
    n = t.arguments.getDeepSubSelectionValue(e.selectionPath);
  n instanceof pe && ((o = n.getDeepFieldValue(e.argumentPath)) == null || o.markAsError()),
    t.addErrorMessage((i) => {
      let s = bo(
        'or',
...
function al(e, t) {
  for (let r of t.fields) e.hasField(r.name) || e.addSuggestion(new at(r.name, 'true'));
}
function Zg(e, t) {
  for (let r of t) e.hasField(r.name) || e.addSuggestion(new at(r.name, r.typeNames.join(' | ')));
}
function ul(e, t) {
  if (t.kind === 'object')
    for (let r of t.fields)
      e.hasField(r.name) || e.addSuggestion(new at(r.name, r.typeNames.join(' | ')));
}
function ho(e) {
  let t = [...e],
    r = t.pop();
...
function oy(e, t, r) {
  for (let [n, o] of Object.entries(t)) {
    ...
    i &&
      ...
      o === !0 ? (e[n] = !0) : typeof o == 'object' && (e[n] = Ki(o, r.nestSelection(n)));
  }
}
function iy(e, t) {
  let r = {},
  ...
  for (let [i, s] of Object.entries(o)) {
    let a = t.findField(i);
    (n != null && n[i] && !a) ||
      (s === !0 ? (r[i] = !0) : typeof s == 'object' && (r[i] = Ki(s, t.nestSelection(i))));
  }
  return r;
}
function cl(e, t) {
  ...
  if (cr(e)) return { $type: 'FieldRef', value: { _ref: e.name, _container: e.modelName } };
  ...
  if (e instanceof nt) {
    if (e !== li.instances[e._getName()]) throw new Error('Invalid ObjectEnumValue');
    ...
    (n) => {
      ...
      if (Array.isArray(n)) {
        ...
        switch (t) {
          case 'sqlite':
          case 'mysql': {
            (o = n.sql), (i = { values: un(n.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'cockroachdb':
          case 'postgresql':
          case 'postgres': {
            (o = n.text), (i = { values: un(n.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'sqlserver': {
            (o = dl(n)), (i = { values: un(n.values), __prismaRawParameters__: !0 });
            break;
          }
          default:
      ...
      return (
        i != null && i.values ? hl(`prisma.${e}(${o}, ${i.values})`) : hl(`prisma.${e}(${o})`),
...
function hy(e, t) {
  return Eo(e) && (t == null ? void 0 : t.kind) === 'batch' && e.batchRequestIdx !== t.index;
}
function by(e) {
...
var kl = ['datasources', 'datasourceUrl', 'errorFormat', 'adapter', 'log', '__internal'],
        ...
        if (r && typeof r == 'object')
          for (let [o, i] of Object.entries(r))
            if (n[o]) n[o](i);
              ...
              throw new re(`Invalid property ${o} for "log" provided to PrismaClient constructor`);
      }
    },
    __internal: (e) => {
      if (!e) return;
  ...
  class t {
        ...
        if (
          ...
          (this._engineConfig = {
            ...
            logQueries:
              ...
              !!(typeof _.log == 'string'
                ? _.log === 'query'
                : _.log.find((O) => (typeof O == 'string' ? O === 'query' : O.level === 'query'))),
          ...
          for (let O of _.log) {
            let k = typeof O == 'string' ? O : O.emit === 'stdout' ? O.level : null;
            k &&
              this.$on(k, (K) => {
                var Q;
                nr.log(`${(Q = nr.tags[k]) != null ? Q : ''}`, K.message || K.query);
              });
          }
    ...
    $executeRawInternal(n, o, i, s) {
      ...
      return this._request({
        ...
        transaction: n,
        clientMethod: o,
        argsMapper: Ji({ clientMethod: o, activeProvider: a, driverAdapterProvider: u }),
    ...
    $executeRawUnsafe(n, ...o) {
      return this._createPrismaPromise(
        (i) => (
          Qi(this._activeProvider, n, o, 'prisma.$executeRawUnsafe(<SQL>, [...values])'),
    ...
    _transactionWithArray({ promises: n, options: o }) {
      let i = Ty.nextId(),
        ...
        a = n.map((u, l) => {
          ...
          return (A = (h = u.requestTransaction) == null ? void 0 : h.call(u, y)) != null ? A : u;
        });
      return Bl(a);
    }
