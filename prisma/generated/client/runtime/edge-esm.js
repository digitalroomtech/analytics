  ...
  Yl = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let o of Wl(t))
        !zl.call(e, o) &&
          o !== r &&
          Po(e, o, { get: () => t[o], enumerable: !(n = Gl(t, o)) || n.enumerable });
    return e;
  };
var ve = (e, t, r) => (
  (r = e != null ? Jl(Hl(e)) : {}),
  Yl(t || !e || !e.__esModule ? Po(r, 'default', { value: e, enumerable: !0 }) : r, e)
);
function V(e) {
  return () => e;
}
...
var Es = ee((Kt) => {
  ...
  function Xe(e) {
    if (e > sn) throw new RangeError('The value "' + e + '" is invalid for option "size"');
  ...
  function oc(e) {
    ...
    if (e.length !== void 0) return typeof e.length != 'number' || Ro(e.length) ? Xe(0) : To(e);
    if (e.type === 'Buffer' && Array.isArray(e.data)) return To(e.data);
  }
  function So(e) {
    if (e >= sn)
      throw new RangeError(
        'Attempt to allocate Buffer larger than maximum size: 0x' + sn.toString(16) + ' bytes',
      );
    return e | 0;
  }
  function ic(e) {
  ...
  _.prototype.toString = function () {
    let e = this.length;
    return e === 0 ? '' : arguments.length === 0 ? ds(this, 0, e) : sc.apply(this, arguments);
  };
  ...
  function fc(e, t, r) {
    return t === 0 && r === e.length ? _o.fromByteArray(e) : _o.fromByteArray(e.slice(t, r));
  }
  function ds(e, t, r) {
  ...
  function dc(e) {
    ...
    let r = '',
      n = 0;
    for (; n < t; ) r += String.fromCharCode.apply(String, e.slice(n, (n += is)));
    return r;
  }
  function mc(e, t, r) {
    let n = '';
  ...
  _.prototype.readFloatLE = function (e, t) {
    return (e = e >>> 0), t || se(e, 4, this.length), qt.read(this, e, !0, 23, 4);
  };
  _.prototype.readFloatBE = function (e, t) {
    return (e = e >>> 0), t || se(e, 4, this.length), qt.read(this, e, !1, 23, 4);
  };
  _.prototype.readDoubleLE = function (e, t) {
    return (e = e >>> 0), t || se(e, 8, this.length), qt.read(this, e, !0, 52, 8);
  };
  _.prototype.readDoubleBE = function (e, t) {
    return (e = e >>> 0), t || se(e, 8, this.length), qt.read(this, e, !1, 52, 8);
  };
  ...
  _.prototype.writeBigInt64LE = lt(function (e, t = 0) {
    return ms(this, e, t, -BigInt('0x8000000000000000'), BigInt('0x7fffffffffffffff'));
  });
  _.prototype.writeBigInt64BE = lt(function (e, t = 0) {
    return gs(this, e, t, -BigInt('0x8000000000000000'), BigInt('0x7fffffffffffffff'));
  });
  ...
  function bc(e, t, r) {
    Vt(t, 'offset'), (e[t] === void 0 || e[t + r] === void 0) && br(t, e.length - (r + 1));
  }
  ...
  function Vt(e, t) {
    if (typeof e != 'number') throw new $t.ERR_INVALID_ARG_TYPE(t, 'number', e);
  }
  function br(e, t, r) {
    throw Math.floor(e) !== e
      ? (Vt(e, r), new $t.ERR_OUT_OF_RANGE(r || 'offset', 'an integer', e))
      : t < 0
        ? new $t.ERR_BUFFER_OUT_OF_BOUNDS()
        : new $t.ERR_OUT_OF_RANGE(r || 'offset', `>= ${r ? 1 : 0} and <= ${t}`, e);
  }
  var wc = /[^+/0-9A-Za-z-_]/g;
  function xc(e) {
    if (((e = e.split('=')[0]), (e = e.trim().replace(wc, '')), e.length < 2)) return '';
...
var $o = ee((K) => {
  ...
  var te = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
        ...
        for (var _t = 1, Ze = !0; _t < F.length; _t += 1) {
          ...
          if (
            ...
            if (a && _t + 1 >= F.length) {
              var Ut = a(oe, Pe);
              (Ze = !!Ut),
                Ze && 'get' in Ut && !('originalValue' in Ut.get) ? (oe = Ut.get) : (oe = oe[Pe]);
    ...
    Fc = te((e) => {
      ...
      function st(C) {
        return typeof Map > 'u' ? !1 : Ie.working ? Ie(C) : C instanceof Map;
      }
      e.isMap = st;
      function J(C) {
      ...
      function _t(C) {
        return typeof DataView > 'u' ? !1 : ut.working ? ut(C) : C instanceof DataView;
      }
      e.isDataView = _t;
  ...
  K.format = function (e) {
    if (!gn(e)) {
      for (var t = [], r = 0; r < arguments.length; r++) t.push(pt(arguments[r]));
      return t.join(' ');
    }
    for (
      var r = 1,
  ...
  function Bc(e, t) {
    var r = pt.styles[t];
    return r ? '\x1B[' + pt.colors[r][0] + 'm' + e + '\x1B[' + pt.colors[r][1] + 'm' : e;
  }
  function jc(e, t) {
    return e;
  }
  ...
  function pn(e, t, r) {
    ...
    if (
      ...
      xr(t) && (i.indexOf('message') >= 0 || i.indexOf('description') >= 0))
    )
      return ko(t);
    if (i.length === 0) {
      if (cn(t)) {
  ...
  function qc(e, t, r, n, o) {
    for (var i = [], s = 0, a = t.length; s < a; ++s)
      qs(t, String(s)) ? i.push(Do(e, t, r, n, String(s), !0)) : i.push('');
    return (
    ...
    if (
      ...
      a ||
        (e.seen.indexOf(u.value) < 0
          ? (mn(r) ? (a = pn(e, u.value, null)) : (a = pn(e, u.value, r - 1)),
            a.indexOf(`
`) > -1 &&
              (i
                ? (a = a
...
`) >= 0 && n++,
 ...
 `) +
  ...
  var Gc = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  function Wc() {
    var e = new Date(),
  ...
  function zc(e) {
    ...
    return Object.setPrototypeOf(t, Object.getPrototypeOf(e)), Object.defineProperties(t, Bs(e)), t;
  }
  K.callbackify = zc;
});
var Ks = ee((Yh, Vs) => {
...
var Zs = ee((Cb, Ys) => {
  ...
  Le('no-color') || Le('no-colors') || Le('color=false') || Le('color=never')
    ? (ft = 0)
    : (Le('color') || Le('colors') || Le('color=true') || Le('color=always')) && (ft = 1);
  'FORCE_COLOR' in ae &&
    (ae.FORCE_COLOR === 'true'
      ? (ft = 1)
      : ae.FORCE_COLOR === 'false'
        ? (ft = 0)
        : (ft = ae.FORCE_COLOR.length === 0 ? 1 : Math.min(parseInt(ae.FORCE_COLOR, 10), 3)));
  function Ko(e) {
...
var ea = ee((me, xn) => {
  ...
  function mp() {
    return 'colors' in me.inspectOpts ? !!me.inspectOpts.colors : dp.isatty(h.stderr.fd);
  }
  function gp(e) {
...
`,
  ...
  function xp(e) {
    ...
    for (let r = 0; r < t.length; r++) e.inspectOpts[t[r]] = me.inspectOpts[t[r]];
  }
  xn.exports = qo()(me);
...
`,
  ...
  Xs.O = function (e) {
    return (this.inspectOpts.colors = this.useColors), wn.inspect(e, this.inspectOpts);
  };
});
var ta = ee((Nb, Jo) => {
  'use strict';
...
var zo = ee((L0, fa) => {
  ...
  var Zt = {
    ...
    relative: function (e, t) {
      if ((Qe(e), Qe(t), e === t || ((e = Zt.resolve(e)), (t = Zt.resolve(t)), e === t))) return '';
...
var xa = ee((Ew, Zo) => {
  ...
  var Rp = Object.prototype.hasOwnProperty,
    _e = '~';
  function vr() {}
  Object.create && ((vr.prototype = Object.create(null)), new vr().__proto__ || (_e = !1));
  function Op(e, t, r) {
  ...
  we.prototype.eventNames = function () {
    ...
    for (r in (t = this._events)) Rp.call(t, r) && e.push(_e ? r.slice(1) : r);
...
var Os = {};
hr(Os, { Extensions: () => Cs, Public: () => Ss, Result: () => Ms, Utils: () => Rs });
m();
p();
f();
d();
...
var Io = class {
  ...
  buildInputTypesMap() {
    let t = new Map();
    for (let r of this.inputObjectTypes.prisma) t.set(Oo(r.name, 'prisma'), r);
...
var Go,
  ...
  ca = !0;
typeof h != 'undefined' &&
  (({ FORCE_COLOR: Go, NODE_DISABLE_COLORS: aa, NO_COLOR: ua, TERM: la } = h.env || {}),
  (ca = h.stdout && h.stdout.isTTY));
var vp = { enabled: !aa && ua == null && la !== 'dumb' && ((Go != null && Go !== '0') || ca) };
function z(e, t) {
...
function Bp(e) {
  return { datamodel: { models: oi(e.models), enums: oi(e.enums), types: oi(e.types) } };
}
function oi(e) {
...
f();
d();
var c1 = ['JsonNullValueInput', 'NullableJsonNullValueInput', 'JsonNullValueFilter'],
  On = Symbol(),
  ii = new WeakMap(),
  et = class {
    constructor(t) {
...
var si = {
  ...
  instances: { DbNull: new Sr(On), JsonNull: new Mr(On), AnyNull: new Rr(On) },
};
function ai(e, t) {
  Object.defineProperty(e, 'name', { value: t, configurable: !0 });
}
...
var ui = class {
  ...
  li = (e) => {
    ...
    return {
      ...
      provider: e.provider,
      startTransaction: async (...n) => (await r(...n)).map((i) => Up(t, i)),
    };
  },
  Up = (e, t) => ({
    provider: t.provider,
      ...
      getOwnPropertyDescriptor(i, s) {
        ...
        return u
          ? u.getPropertyDescriptor
            ? { ...kn, ...(u == null ? void 0 : u.getPropertyDescriptor(s)) }
            : kn
          : a;
      },
...
A.inverseTangent = A.atan = function () {
  ...
  if (l.isFinite()) {
    ...
    if (l.abs().eq(1) && g + 4 <= fi) return (s = Ue(c, g + 4, y).times(0.25)), (s.s = l.s), s;
  } else {
...
A.logarithm = A.log = function (e) {
  ...
  if (
    ...
    do
      if (
        ((a += 10), (s = ht(l, a)), (n = t ? jn(c, a + 10) : ht(e, a)), (u = H(s, n, a, 1)), !i)
      ) {
...
A.minus = A.sub = function (e) {
  ...
  if (((r = xe(e.e / L)), (c = xe(P.e / L)), (l = l.slice()), (i = c - r), i)) {
    for (
      g = i < 0,
  ...
  for (; l[--s] === 0; ) l.pop();
  for (; l[0] === 0; l.shift()) --r;
  return l[0] ? ((e.d = l), (e.e = $n(l, r)), j ? D(e, a, u) : e) : new v(u === 3 ? -0 : 0);
};
...
A.plus = A.add = function (e) {
  ...
  if (((i = xe(g.e / L)), (n = xe(e.e / L)), (l = l.slice()), (o = i - n), o)) {
    for (
...
A.times = A.mul = function (e) {
  ...
  for (; !i[--s]; ) i.pop();
  return t ? ++r : i.shift(), (e.d = i), (e.e = $n(i, r)), j ? D(e, g.precision, g.rounding) : e;
};
...
A.toDecimalPlaces = A.toDP = function (e, t) {
  ...
  return (
    ...
    e === void 0
      ? r
      : (Se(e, 0, wt), t === void 0 ? (t = n.rounding) : Se(t, 0, 8), D(r, e + r.e + 1, t))
  );
};
...
var H = (function () {
  ...
  return function (n, o, i, s, a, u) {
    ...
    for (
      u ? ((P = 1), (c = n.e - o.e)) : ((u = $e), (P = L), (c = xe(n.e / P) - xe(o.e / P))),
        ne = F.length,
        re = Q.length,
        M = new st(J),
        O = M.d = [],
    ...
    if (
      ...
      if (((q = (q / P + 2) | 0), (g = 0), ne == 1)) {
        for (y = 0, F = F[0], q++; (g < re || y) && q--; g++)
          (Ne = y * u + (Q[g] || 0)), (O[g] = (Ne / F) | 0), (y = Ne % F | 0);
        v = y || g < re;
      } else {
        for (
          y = (u / (F[0] + 1)) | 0,
          ...
          S[R++] = 0;
        (Ie = F.slice()), Ie.unshift(0), (Oe = F[0]), F[1] >= u / 2 && ++Oe;
        do
          (y = 0),
            (l = t(F, S, ne, R)),
            l < 0
...
function Ja(e, t, r, n) {
  var o,
    ...
    s = Math.ceil(n / L + 4);
  for (j = !1; ; ) {
    if ((r % 2 && ((i = i.times(t)), Ba(i.d, s) && (o = !0)), (r = xe(r / 2)), r === 0)) {
...
function zp(e, t) {
  ...
  for (
    i = t.search(/p/i),
      ...
      s = i >= 0,
      n = e.constructor,
      s && ((t = t.replace('.', '')), (a = t.length), (i = a - i), (o = Ja(n, new n(r), i, i * 2))),
      l = Nn(t, r, $e),
      c = l.length - 1,
      i = c;
    l[i] === 0;
...
function Ha(e, t) {
  ...
  if (((r = t.divToInt(o)), r.isZero())) tt = n ? 3 : 2;
    ...
    if (((t = t.minus(r.times(o))), t.lte(i))) return (tt = La(r) ? (n ? 2 : 3) : n ? 4 : 1), t;
    tt = La(r) ? (n ? 1 : 4) : n ? 3 : 2;
  }
...
function Cf(e) {
  var t,
    ...
    s = new this(1),
    a = [];
  if ((e === void 0 ? (e = this.precision) : Se(e, 1, wt), (n = Math.ceil(e / L)), this.crypto))
...
function lr(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [o, i]) => (nu[o] !== void 0 ? (n.select[o] = { select: i }) : (n[o] = i), n),
    { select: {} },
  );
}
function Xf(e = {}) {
...
function td(e = {}) {
  return typeof e.select == 'object' ? (t) => Wn(e)(t)._count : (t) => Wn(e)(t)._count._all;
}
function iu(e, t) {
...
var lu = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  cu = (e, t, r) =>
    lu(t).reduceRight((n, o, i, s) => Object.assign({}, wi(e, s.slice(0, i)), { [o]: n }), r);
function od(e, t) {
...
var ad = (e) => e,
  ...
  U = {
    ...
    util: {
      ...
      objId: function (e) {
        return e.__id || Object.defineProperty(e, '__id', { value: ++ud }), e.__id;
      },
...
function dd({ callsite: e, message: t, originalMethod: r, isPanic: n, callArguments: o }, i) {
  var g;
  let s = {
  ...
  let u = Math.max(1, a.lineNumber - 3),
    l = (g = zn.read(a.fileName)) == null ? void 0 : g.slice(u, a.lineNumber),
...
function bd(e, t, r) {
  return async (n) => {
    ...
    return await r(n).catch((i) => {
      throw i instanceof ge && i.code === 'P2025' ? new gt(`No ${e} found`, t) : i;
    });
  };
}
m();
...
f();
d();
function Zn({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: o }) {
  var s;
  if (Array.isArray(t)) {
    for (let a = 0; a < t.length; a++)
      t[a] = Zn({ result: t[a], args: r, modelName: o, runtimeDataModel: n, visitor: e });
    return t;
  }
...
function xu({
  ...
  for (let [i, s] of Object.entries(e)) {
    ...
    t[i] = Zn({ visitor: o, result: t[i], args: l, modelName: u.type, runtimeDataModel: n });
  }
}
function Eu({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: o }) {
  return n.isEmpty() || e == null || typeof e != 'object' || !o.models[t]
    ...
    : Zn({
        ...
        modelName: t,
        runtimeDataModel: o,
        visitor: (s, a, u) => wu({ result: s, modelName: ze(a), select: u.select, extensions: n }),
      });
}
m();
p();
      ...
      n === r.length
        ...
        : r[n]({
            ...
            query: (u, l = t) => {
              ...
              return (l.customDataProxyFetch = Su(i, c)), (l.args = u), _u(e, l, r, n + 1);
            },
          })
    );
  });
...
function Ru(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ? e
    : Sd({ ...e, ...Mu(t.name, e, t.result.$allModels), ...Mu(t.name, e, t.result[n]) });
}
function Sd(e) {
  let t = new Je(),
    r = (n, o) =>
...
function ro({ inlineDatasources: e, overrideDatasources: t, env: r, clientVersion: n }) {
  var u, l;
  let o,
    i = Object.keys(e)[0],
...
To solve this, provide the connection string directly: https://pris.ly/d/cloudflare-datasource-url`,
  ...
  if (o === void 0) throw new Z('error: Missing URL environment variable, value, or override.', n);
  return o;
}
m();
p();
...
async function Hr(e, t) {
  ...
  if (n.type === 'DataProxyError') {
    ...
    if ('InvalidRequestError' in n.body) throw new Qr(r, n.body.InvalidRequestError.reason);
  }
        ...
        callback: async ({ logHttpCall: s }) => {
          ...
          if ((c && this.propagateResponseExtensions(c), l.errors))
            throw l.errors.length === 1
              ...
              : new ye(l.errors, { clientVersion: this.config.clientVersion });
          return l;
        },
      });
    }
    ...
    async withRetry(r) {
      ...
      for (let o = 0; ; o++) {
        ...
        try {
          ...
          this.logEmitter.emit('warn', {
            message: `Attempt ${o + 1}/${Ju} failed for ${r.actionGerund}: ${
...
var Qd = typeof TextDecoder == 'undefined' ? (0, module.require)('util').TextDecoder : TextDecoder,
  Wu = new Qd('utf-8', { ignoreBOM: !0, fatal: !0 });
Wu.decode();
var oo = null;
function uo() {
  return (oo === null || oo.byteLength === 0) && (oo = new Uint8Array(k.memory.buffer)), oo;
}
function en(e, t) {
...
var ce = 0,
  Jd = typeof TextEncoder == 'undefined' ? (0, module.require)('util').TextEncoder : TextEncoder,
  lo = new Jd('utf-8'),
  Gd =
...
var io = null;
function De() {
  return (io === null || io.byteLength === 0) && (io = new Int32Array(k.memory.buffer)), io;
}
var so = null;
function Wd() {
  return (so === null || so.byteLength === 0) && (so = new Float64Array(k.memory.buffer)), so;
}
var ao = null;
function Hd() {
  return (ao === null || ao.byteLength === 0) && (ao = new BigInt64Array(k.memory.buffer)), ao;
}
function Di(e) {
  let t = typeof e;
  ...
  Xr = class {
    ...
    query(t, r, n) {
      let o = Ee(t, k.__wbindgen_malloc, k.__wbindgen_realloc),
        ...
        a = ce;
      var u = ot(n) ? 0 : Ee(n, k.__wbindgen_malloc, k.__wbindgen_realloc),
        l = ce;
  ...
  Hu = {
    async loadLibrary(e) {
      ...
      if (qi === void 0) {
        ...
        (qi = new WebAssembly.Instance(i, { './query_engine_bg.js': $i }).exports), Ui(qi);
      }
      return {
        debugPanic() {
...
var Ek = [...Ho, 'native'],
  ...
  tn = class extends pr {
      ...
      let r = async () => {
        ...
        try {
          ...
          throw typeof i == 'string'
            ? o
            : new Z(i.message, this.config.clientVersion, i.error_code);
        } finally {
    ...
    async stop() {
      ...
      let r = async () => {
        var o;
        await new Promise((i) => setTimeout(i, 5)), Ye('library stopping');
      ...
      try {
        ...
        if (l.errors)
          throw l.errors.length === 1
            ...
            : new ye(JSON.stringify(l.errors), { clientVersion: this.config.clientVersion });
        if (this.loggerRustPanic) throw this.loggerRustPanic;
        return { data: l, elapsed: 0 };
      } catch (l) {
        if (l instanceof Z) throw l;
        if (l.code === 'GenericFailure' && (u = l.message) != null && u.startsWith('PANIC:'))
          throw new Be(this.getErrorMessageWithLink(l.message), this.config.clientVersion);
...
${c.backtrace}`,
    ...
    async requestBatch(r, { transaction: n, traceparent: o }) {
      ...
      if (a.errors)
        throw a.errors.length === 1
          ...
          : new ye(JSON.stringify(a.errors), { clientVersion: this.config.clientVersion });
    ...
    getExternalAdapterError(r) {
      ...
      if (r.error_code === Mg && this.config.adapter) {
        ...
        Sn(typeof o == 'number', 'Malformed external JS error received from the engine');
...
function kg(e) {
  ...
  for (let n of e) {
    ...
    i
      ? t.set(o, {
          ...n,
          argument: { ...n.argument, typeNames: Fg(i.argument.typeNames, n.argument.typeNames) },
        })
      : t.set(o, n);
  }
...
function Lg(e, t) {
  ...
  if (i && ((a = i.getField(n)) == null || a.markAsError(), o))
    for (let u of o.fields) u.isRelation && i.addSuggestion(new it(u.name, 'true'));
  t.addErrorMessage((u) => {
...
function jg(e, t) {
  ...
  o && ((i = o.value.getField(n)) == null || i.markAsError(), sl(o.value, e.outputType)),
    t.addErrorMessage((s) => {
...
function Ug(e, t) {
  ...
  n instanceof ue && ((o = n.getField(r)) == null || o.markAsError(), Wg(n, e.arguments)),
    t.addErrorMessage((i) =>
      ol(
        i,
        r,
...
function ol(e, t, r) {
  let n = [`Unknown argument \`${e.red(t)}\`.`],
    o = zg(t, r);
  return o && n.push(`Did you mean \`${e.green(o)}\`?`), r.length > 0 && n.push(rn(e)), n.join(' ');
}
function qg(e, t) {
  let r;
  t.addErrorMessage((u) =>
...
function Xg(e, t) {
  let r = {};
  return (
    e.model && !e.isRawAction() && ((r.$composites = !0), (r.$scalars = !0)), t && ey(r, t, e), r
  );
}
function ey(e, t, r) {
  for (let [n, o] of Object.entries(t)) {
    ...
    i &&
      ...
      o === !0 ? (e[n] = !0) : typeof o == 'object' && (e[n] = Qi(o, r.nestSelection(n)));
  }
}
function ty(e, t) {
  let r = {},
  ...
  for (let [i, s] of Object.entries(o)) {
    let a = t.findField(i);
    (n != null && n[i] && !a) ||
      (s === !0 ? (r[i] = !0) : typeof s == 'object' && (r[i] = Qi(s, t.nestSelection(i))));
  }
  return r;
}
function ll(e, t) {
  ...
  if (e instanceof et) {
    if (e !== si.instances[e._getName()]) throw new Error('Invalid ObjectEnumValue');
...
var ay = /^(\s*alter\s)/i,
  yl = be('prisma:client');
function Ji(e, t, r, n) {
  if (!(e !== 'postgresql' && e !== 'cockroachdb') && r.length > 0 && ay.exec(t))
...
var Gi =
    ...
    (n) => {
      ...
      if (Array.isArray(n)) {
        let [s, ...a] = n;
        (o = s), (i = { values: nn(a || []), __prismaRawParameters__: !0 });
      } else
        switch (t) {
          case 'sqlite':
          case 'mysql': {
            (o = n.sql), (i = { values: nn(n.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'cockroachdb':
          case 'postgresql':
          case 'postgres': {
            (o = n.text), (i = { values: nn(n.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'sqlserver': {
            (o = fl(n)), (i = { values: nn(n.values), __prismaRawParameters__: !0 });
            break;
          }
          default:
      ...
      return (
        i != null && i.values ? yl(`prisma.${e}(${o}, ${i.values})`) : yl(`prisma.${e}(${o})`),
    ...
    constructor(t, r) {
      (this.logEmitter = r),
        ...
        (this.dataloader = new xo({
          batchLoader: Au(async ({ requests: n, customDataProxyFetch: o }) => {
...
function dy(e, t) {
  return bo(e) && (t == null ? void 0 : t.kind) === 'batch' && e.batchRequestIdx !== t.index;
}
function my(e) {
...
var Il = ['datasources', 'datasourceUrl', 'errorFormat', 'adapter', 'log', '__internal'],
...
var by = { requestArgsToMiddlewareArgs: (e) => e, middlewareArgsToRequestArgs: (e) => e },
  ...
  class t {
        ...
        if (
          ...
          for (let S of v.log) {
            ...
            R &&
              this.$on(R, ($) => {
                var q;
                Xt.log(`${(q = Xt.tags[R]) != null ? q : ''}`, $.message || $.query);
              });
          }
    ...
    $executeRawInternal(n, o, i, s) {
      ...
      return this._request({
        ...
        transaction: n,
        clientMethod: o,
        argsMapper: Gi({ clientMethod: o, activeProvider: a, driverAdapterProvider: u }),
    ...
    $executeRawUnsafe(n, ...o) {
      return this._createPrismaPromise(
        (i) => (
          Ji(this._activeProvider, n, o, 'prisma.$executeRawUnsafe(<SQL>, [...values])'),
...
function _y(e) {
  return new Proxy(e, {
    get(t, r) {
      ...
      if (!vy.has(r)) throw new TypeError(`Invalid enum value: ${String(r)}`);
    },
  });
}
m();
